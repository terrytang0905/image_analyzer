...
def classfiy_dHash(image1,image2):
	...
	'''
	newsize = (9, 8)
	image1 = image1.resize(newsize).convert('L')
	code1 = getCode(image1, newsize)


	image2 = image2.resize(newsize).convert('L')
	code2 = getCode(image2, newsize)
...
if __name__ == '__main__':
    image1 = Image.open("./image_mapping/256.png").convert('RGBA')
    image2 = Image.open("./image_src/132.png").convert('RGBA')
    result=classfiy_dHash(image1, image2)
    print("result",result)